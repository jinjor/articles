...
今回は社内の[データ基盤](https://zenn.dev/knowledgework/articles/knowledgework-data-platform-20250905) を使い、GCS にアップロードしたデータを BigQuery から取得、という流れで集計を行いました。カバレッジを集計するのはクエリ側です。
